...
export function AlazSections() {
  ...
  const c = lang === "es" ? {
    ...
    s1Body2: "Durante este período trabajé como lead de diseño de producto en tres programas de clientes simultáneos: Wetrax (trade tech), Clínica San Felipe (servicios digitales de salud) y EGCAPP (SaaS de sector público). Cada proyecto tenía restricciones operativas únicas, contexto regulatorio y presiones de entrega — exigiendo enfoques radicalmente distintos desde el mismo toolkit base.",
    ...
    s1MetaIndustries: "Trade Tech · Salud · SaaS de Sector Público",
    ...
    s3Title: "Wetrax: Trade Tech Bajo Velocidad",
    s3BodyAccent: "Wetrax es una plataforma de trade tech",
    s3BodyRest: " que conecta traders y operadores a través de herramientas de análisis, ejecución en tiempo real y funcionalidades de comunidad. El desafío: iterar lo suficientemente rápido para mantenerse por delante de una ventana competitiva de trade tech — sin sacrificar las señales de calidad que retenían usuarios.",
    ...
    s1Body2: "During this engagement period I worked as a product design lead across three simultaneous client programs: Wetrax (trade tech), Clínica San Felipe (healthcare digital services), and EGCAPP (government-adjacent SaaS). Each project carried unique operational constraints, regulatory context, and delivery pressures — demanding radically different approaches from the same foundational toolkit.",
    ...
    s1MetaIndustries: "Trade Tech · Healthcare · Public Sector SaaS",
