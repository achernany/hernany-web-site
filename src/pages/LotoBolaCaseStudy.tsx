...
/* ============================================================
   CasePlaceholder
   Renders a stable, labeled placeholder for every visual asset.
   Replace the inner <div class="cs-placeholder"> with an <img>
   or <video> tag when final assets are ready. The `id` prop
   matches the asset ID in the brief (e.g., "LB-HERO-01").
   ============================================================ */

type PlaceholderRatio = "hero" | "wide" | "landscape" | "portrait" | "card" | "square";

interface CasePlaceholderProps {
  /** Asset ID — visible in UI and used for swap reference */
  id: string;
  /** Aspect ratio shorthand */
  ratio?: PlaceholderRatio;
  /** Optional visible caption below the placeholder */
  caption?: string;
  /** Optional content type hint shown inside the box */
  hint?: string;
  className?: string;
}
        ...
        <div className="cs-body">
          ...
          <section className="cs-section cs-section--hero" id="hero">
            ...
            <CasePlaceholder
              id="LB-HERO-01"
              ratio="hero"
              hint="System overview — composed mosaic"
            />
          ...
          <section className="cs-section" id="challenge">
            ...
            <div className="cs-section-content">
              <div className="cs-callout">
                <Typography variant="bodyLg" tone="secondary">
                  <Accent>
                    A lottery product is not just a screen problem.
                  </Accent>{" "}
              ...
              <div className="cs-module-grid">
                ...
                <div className="cs-module-item">
                  ...
                  <CasePlaceholder
                    ...
                    ratio="landscape"
                    hint="Website"
                    className="cs-module-item__placeholder"
                  />
                  <Typography variant="h3">Website</Typography>
                  <Typography variant="bodyMd" tone="secondary">
                    Public-facing entry point. Explains the product, builds trust,
                ...
                <div className="cs-module-item">
                  ...
                  <Typography variant="bodyMd" tone="secondary">
                    Structured email templates supporting communication consistency
                    and repeatability.
                  </Typography>
                </div>
                ...
                <div className="cs-module-item">
                  ...
                  <Typography variant="bodyMd" tone="secondary">
                    Shared foundations aligning patterns, components, and visual language
                    across all surfaces.
                  </Typography>
                </div>
          ...
          <section className="cs-section" id="service">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-SERVICE-01"
                ratio="wide"
                hint="Journey map / service blueprint"
              />
          ...
          <section className="cs-section" id="customer">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-WEB-01"
                ratio="landscape"
                hint="Website showcase — full page"
              />
          ...
          <section className="cs-section" id="retail">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-RETAIL-01"
                ratio="wide"
                hint="Retail interface / POS overview"
              />
          ...
          <section className="cs-section" id="admin">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-ADMIN-01"
                ratio="landscape"
                hint="Admin dashboard / control panel"
              />
          ...
          <section className="cs-section" id="communications">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-COMMS-03"
                ratio="wide"
                hint="Communication system — full spread"
              />
            </div>
          </section>
          ...
          <section className="cs-section" id="design-system">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-DS-01"
                ratio="landscape"
                hint="Design system — component library"
              />
          ...
          <section className="cs-section" id="reflection">
            ...
            <div className="cs-section-content">
              ...
              <CasePlaceholder
                id="LB-CLOSING-01"
                ratio="landscape"
                hint="Closing visual — composed final"
              />
            </div>
          </section>
          ...
          {/* ════════════════════════════════════════════
              ...
              Lighter section — optional / secondary reading
              ════════════════════════════════════════════ */}
